...
function getAllPossibleCoordsKing(pieceCoord) {
    ...
    if (nextCoord.i < 0) nextCoord.i = 0
    else if (isEmptyCell(nextCoord)) res.push(nextCoord);

    var nextCoord = { i: pieceCoord.i + 1, j: pieceCoord.j };
    if (nextCoord.i > 7) nextCoord.i = 7
    else if (isEmptyCell(nextCoord)) res.push(nextCoord);

    var nextCoord = { i: pieceCoord.i, j: pieceCoord.j + 1 };
    if (nextCoord.j > 7) nextCoord.j = 7
    else if (isEmptyCell(nextCoord)) res.push(nextCoord);

    var nextCoord = { i: pieceCoord.i, j: pieceCoord.j - 1 };
    if (nextCoord.j < 0) nextCoord.j = 0
    else if (isEmptyCell(nextCoord)) res.push(nextCoord);

    var nextCoord = { i: pieceCoord.i - 1, j: pieceCoord.j -1};
    if (nextCoord.i < 0) nextCoord.i = 0
    if (nextCoord.j < 0) nextCoord.j = 0
    else if (isEmptyCell(nextCoord)) res.push(nextCoord);
...
function getAllPossibleCoordsKnight(pieceCoord) {
    ...
    var nextCoord = { i: pieceCoord.i - 2, j: pieceCoord.j + 1 };
    if (nextCoord.i < 0) nextCoord.i = 0
    if (nextCoord.j > 7) nextCoord.j = 7
    if (nextCoord.j < 0) nextCoord.j = 0
    else if (isEmptyCell(nextCoord)) res.push(nextCoord);
    ...
    var nextCoord = { i: pieceCoord.i + 1, j: pieceCoord.j + 2 };
    if (nextCoord.i > 7) nextCoord.i = 7
    if (nextCoord.i < 0) nextCoord.i = 0
    if (nextCoord.j > 7) nextCoord.j = 7
    else if (isEmptyCell(nextCoord)) res.push(nextCoord);
